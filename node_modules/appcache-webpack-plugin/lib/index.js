...
var AppCache = (function () {
  function AppCache(cache, network, fallback, settings, hash) {
  ...
  _createClass(AppCache, [{
    ...
    value: function source() {
      return ['CACHE MANIFEST', '# ' + this.hash, '', this.getManifestBody()].join('\n');
    }
  }]);
  ...
  _createClass(AppCachePlugin, [{
    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('emit', function (compilation, callback) {
        var appCache = new AppCache(_this.cache, _this.network, _this.fallback, _this.settings, compilation.hash);
